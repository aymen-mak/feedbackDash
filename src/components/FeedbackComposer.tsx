...
export default function FeedbackComposer({ category, onSubmit }: FeedbackComposerProps) {
  ...
  return (
    <div className="rounded-2xl bg-makina-card border border-makina-border p-4 hover-lift animate-fade-in-up">
      ...
      <div className="flex gap-2">
        ...
        <button
          ...
          className="self-end rounded-xl gradient-accent p-3 text-makina-bg transition-all hover:brightness-110 disabled:opacity-40 disabled:cursor-not-allowed"
        >
